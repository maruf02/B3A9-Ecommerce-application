...
const OfferBaner = () => {
  return (
    <div className=" mx-12 my-5 bg-[#DDF1F5] rounded-lg    ">
      <div className="w-full h-fit  py-5 flex flex-col md:flex-row lg:flex-row justify-between items-center ">
        ...
        <div className="text-base  lg:text-3xl font-semibold text-black  mr-10">
          <NavLink to="/products" className="block w-full">
            <button className="btn btn-primary btn-md rounded-full md:px-10 text-base ">
              ShopNow
            </button>
          </NavLink>
        </div>
